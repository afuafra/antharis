...
{{--        <form method="POST" action="{{route("devicesites.store")}}" oninput="atollislandsite.value = AtollCity.value +'_'+ IslandDistrict.value+'_'+ Site.value">--}}
{{--            @csrf--}}
{{--                    <div class="mb-3">--}}
...
{{--                    <a href="{{route("devicesites.index")}}" class="btn btn-secondary" data-bs-dismiss="modal">back</a>--}}
