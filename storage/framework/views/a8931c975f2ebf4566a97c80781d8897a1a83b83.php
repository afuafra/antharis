    ...
    <div class="content">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="container-fluid">
                    <a href="<?php echo e(route("services.create")); ?>" type="button" class="btn btn-primary" data-bs-toggle="modal">
                        +Add Service
                    </a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form class="container-fluid" id="serviceCreate" method="POST" action="<?php echo e(route("services.store")); ?>" >
